...
// Replaced Next.js Link with an anchor tag since we are in Laravel
...
function MiniNavbar() {
  ...
  const logoElement = (
    <a href="/" className="font-bold text-white tracking-tighter text-lg flex items-center gap-2">
  ...
  const loginButtonElement = (
    <a href="/login" className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center inline-block">
      Client Login
    </a>
  );
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
       <div className="absolute inset-0 -m-2 rounded-full hidden sm:block bg-blue-500 opacity-40 filter blur-lg pointer-events-none transition-all duration-300 ease-out group-hover:opacity-60 group-hover:blur-xl group-hover:-m-3"></div>
       <a href="/request-quote" className="inline-block relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-white bg-gradient-to-br from-blue-500 to-purple-600 rounded-full hover:from-blue-400 hover:to-purple-500 transition-all duration-200 w-full sm:w-auto text-center">
         Start a Project
       </a>
    </div>
  );
        ...
        {initialCanvasVisible && (
          <div className="absolute inset-0">
            <CanvasRevealEffect
              ...
              colors={[
                [14, 165, 233], // Tailwind sky-500
                [139, 92, 246], // Tailwind violet-500
              ]}
              dotSize={6}
              reverse={false}
            />
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to CleMwa</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Client Portal Access</p>
                    </div>
                      ...
                      <form onSubmit={handleEmailSubmit}>
                        <div className="relative">
                          <input 
                            ...
                            className="w-full backdrop-blur-[1px] text-white border-1 border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border-white/30 text-center bg-transparent"
                            required
                          />
                          <button 
                            type="submit"
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Two-Factor Authentication</h1>
                      <p className="text-[1.25rem] text-white/50 font-light">Enter the code sent to your email</p>
                    </div>
