        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row gap-12 mb-16 items-center">
                ...
                <div class="lg:w-1/2 relative z-10">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-{{ $project->color_theme }}-500/10 border border-{{ $project->color_theme }}-500/20 text-{{ $project->color_theme }}-400 text-sm font-bold uppercase tracking-widest mb-6">
                        Case Study
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-8">
                        @if($project->tags)
                            ...
                            <span class="px-3 py-1.5 rounded-sm bg-{{ $project->color_theme }}-500/10 text-{{ $project->color_theme }}-400 text-xs font-bold tracking-widest border border-{{ $project->color_theme }}-500/20 uppercase">{{ $tag }}</span>
                            @endforeach
                        @endif
                    </div>

                    @if($project->requires_quote)
                    <a href="/quote?project={{ Str::slug($project->subtitle) }}" class="inline-flex items-center justify-center px-8 py-4 bg-{{ $project->color_theme }}-500 hover:bg-{{ $project->color_theme }}-400 text-white font-bold rounded-sm transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-105">
                ...
                <div class="lg:w-1/2 relative w-full">
                    <div class="absolute -inset-4 bg-{{ $project->color_theme }}-500/20 rounded-full blur-[80px]"></div>
                    <div class="relative rounded-sm overflow-hidden border border-white/10 shadow-2xl glass">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div class="glass p-8 rounded-sm border border-white/10 relative overflow-hidden group">
            ...
            <div class="glass p-10 md:p-16 rounded-sm border border-white/10 relative z-10 bg-[#0B0B0F]/80 backdrop-blur-xl mb-16">
            ...
            <!-- Call to Action -->
            <div class="mt-16 text-center glass p-12 rounded-sm border border-white/10 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <a href="/quote?project={{ Str::slug($project->subtitle) }}" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold rounded-sm transition-all hover:scale-105">
