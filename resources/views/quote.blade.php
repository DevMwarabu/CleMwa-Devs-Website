    ...
    <div class="relative pt-32 pb-20 min-h-screen bg-[#050507]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass overflow-hidden rounded-sm hover:-translate-y-2 hover:bg-white/5 transition-all duration-300 group border border-white/10 backdrop-blur-md">
                    ...
                    <div class="p-8 flex flex-col h-[calc(100%-12rem)]">
                        ...
                        <a href="/contact?subject={{ Str::slug($project->subtitle) }}" class="w-full inline-flex justify-center items-center px-6 py-4 bg-{{ $project->color_theme }}-500 hover:bg-{{ $project->color_theme }}-400 text-white font-bold rounded-sm transition-all shadow-lg shadow-{{ $project->color_theme }}-500/25 hover:shadow-{{ $project->color_theme }}-500/40">
                            Get Estimate
                        </a>
                    </div>
                </div>
