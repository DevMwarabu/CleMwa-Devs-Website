        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row gap-12 mb-16 items-center">
                ...
                <div class="lg:w-1/2 relative z-10">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-{{ $service->color_theme }}-500/10 border border-{{ $service->color_theme }}-500/20 text-{{ $service->color_theme }}-400 text-sm font-bold uppercase tracking-widest mb-6">
                    ...
                    <a href="/quote?service={{ $service->slug }}" class="inline-flex items-center justify-center px-8 py-4 bg-{{ $service->color_theme }}-500 hover:bg-{{ $service->color_theme }}-400 text-white font-bold rounded-sm transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-105">
                        Get Started
                    </a>
                </div>
                <!-- Right Image -->
                <div class="lg:w-1/2 relative">
                    <div class="absolute -inset-4 bg-{{ $service->color_theme }}-500/20 rounded-full blur-[80px]"></div>
            ...
            <!-- Content -->
            <div class="glass p-10 md:p-16 rounded-sm border border-white/10 prose prose-invert prose-lg max-w-none shadow-2xl relative z-10 bg-[#0B0B0F]/80 backdrop-blur-xl
